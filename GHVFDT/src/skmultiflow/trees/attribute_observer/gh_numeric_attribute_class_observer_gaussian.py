...
class GhNumericAttributeClassObserverGaussian(AttributeClassObserver):
    ...
    def get_best_evaluated_split_suggestion(self, criterion, pre_split_dist, att_idx, binary_only):
        ...
        for split_value in suggested_split_values:
            ...
            merit = -np.inf
            if ('0' in self._att_val_dist_per_class) and ('1' in self._att_val_dist_per_class):
                if (self._att_val_dist_per_class[0] is not None) and (self._att_val_dist_per_class[1] is not None):
                    ...
                    merit = GaussianHellingerDistanceCriterion.compute_hellinger(p_mean, p_variance,
                                                                                 n_mean, n_variance)
