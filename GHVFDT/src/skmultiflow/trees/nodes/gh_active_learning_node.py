...
from skmultiflow.trees.attribute_observer import GhNumericAttributeClassObserverGaussian
from skmultiflow.trees.nodes import LearningNode


class GhActiveLearningNode(LearningNode):
        ...
        for i in range(len(X)):
            try:
                ...
                if ht.nominal_attributes is not None and i in ht.nominal_attributes:
                    ...
                    obs = GhNumericAttributeClassObserverGaussian()
